...
* TODO : add the fat on the fat secret
...
* TODO : check >s in the org-document by using ag 
...
* TODO : add one hour meeting to table
* TODO : add <s function into vim script, write one write function on the text
...
* TODO : copy the help data into google doc and let it speak up
* TODO : re-edit the .spacemacs, find out the .template, diff with the my version
