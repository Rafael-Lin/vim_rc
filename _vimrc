...
" Formatting {
    ...
    autocmd FileType c,tex,org,cpp,java,txt,cs,go,php,javascript,puppet,python,rust,twig,xml,yml,perl,sql autocmd BufWritePre <buffer> if !exists('g:spf13_keep_trailing_whitespace') | call StripTrailingWhitespace() | endif
    ...
    if has('gui_running')
        ...
        if !exists("g:spf13_no_big_font")
            ...
            elseif WINDOWS() && has("gui_running")
                set guifont=Monaco:h10,Menlo:h10,Consolas:h10,Courier_New:h10
                " set guifont=Source\ Code\ Pro\ Bold\ 13:h13,Menlo:h10,Consolas:h10,Courier_New:h10
            endif
        endif
    else
